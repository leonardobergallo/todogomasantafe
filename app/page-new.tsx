...
// Integra el diseño nuevo con la funcionalidad de base de datos existente

"use client" // Client Component porque usa hooks y eventos
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      {/* Header - diseño del código proporcionado */}
      ...
      {/* Hero Section - diseño exacto del código proporcionado */}
      ...
      {/* Image Grid - galería de imágenes */}
      ...
      {/* About Section - primera sección de texto */}
      ...
      {/* Categories Section - categorías de productos */}
      ...
      {/* Latest Products Section - últimos productos */}
      <section className="py-12 px-4 bg-white">
        <div className="container mx-auto">
          <h2 className="text-2xl font-normal text-center mb-8 uppercase tracking-wide">
            Últimos ingresos
            ...
            <div className="bg-gray-100 p-8 rounded">
              ...
              <form className="space-y-4" action="/api/contact" method="POST">
                ...
                <Textarea
                  ...
                  required
                />
                <Button type="submit" className="bg-[#1a2339] hover:bg-[#1a2339]/90 text-white uppercase px-8">
                  Enviar
                </Button>
              </form>
            </div>
